...
//przycisk info
module.exports.infoBtn = function () {
  $("#mainPart").empty().html("<p class='standardText newRocker'>To kolejna wersja gry Audaces, w której wprowadzone zostały wszystkie nie zrealizowane wcześniej pomysły. Gra powstała dzięki użytym technologiom: HTML5, SASS, jQuery, EcmaScript 6. Fonty pobrane z: fonts.google.com. Dostępne rozdzielczości: 1366x768 px.</p>");
};

//przycisk licencja
module.exports.licenceBtn = function () {
