...
"use strict";
throw new Error("Module build failed: SyntaxError: C:/Users/Asus/Desktop/Audaces - powerfull/js/heroCreator.js: Unexpected token, expected ; (127:7)\n\n  125 | \t\t\t\tconsole.log(weight + \" kg\", height + \" cm\");\n  126 | \t\t\t}else if(race == \"półelf\"){\n> 127 | \t\t\t\tet weight = Math.round(Math.random()*60 + 40);\n      | \t\t\t\t   ^\n  128 | \t\t\t\tlet height = Math.round(Math.random()*45 + 165);\n  129 | \t\t\t\tconsole.log(weight + \" kg\", height + \" cm\");\n  130 | \t\t\t}\n");
